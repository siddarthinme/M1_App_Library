//This function opens the binary file in reading mode and asks the user to enter the book name which wants to search.  If the book is not available in the list, it shows the message book not find in records.
#include "head.h"
void searchBooks()
{
    int found = 0;
