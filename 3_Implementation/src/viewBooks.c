//It opens the file in reading mode and read and display all the stored book details. If there is no book available in the records, then it displays the message record is empty.
#include "head.h"
void viewBooks()
{
    int found = 0;
